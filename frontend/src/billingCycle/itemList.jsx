  ...
  renderRows() {
    ...
    return list.map((item, index) => (
      <tr key={index}>
        ...
        <td>
          <button type='button' disabled={readOnly} className='btn btn-success' 
            onClick={() => this.add(index + 1)}>
            <i className='fa fa-plus'></i>
          </button>
          <button type='button' disabled={readOnly} className='btn btn-warning' 
            onClick={() => this.add(index + 1, item)}>
            <i className='fa fa-clone'></i>
          </button>
          <button type='button' disabled={readOnly} className='btn btn-danger' 
